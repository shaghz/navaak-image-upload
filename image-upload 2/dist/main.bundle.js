...
var UploadplaceComponent = (function () {
    function UploadplaceComponent(http, fb, element, sanitizer) {
        ...
        this.uploader = new __WEBPACK_IMPORTED_MODULE_3_ng2_file_upload__["FileUploader"]({ url: 'http://localhost:3000/upload' });
        ...
        this.uploader.onCompleteItem = function (item, response, status, header) {
            ...
            if (status === 200) {
                return _this.http.post('http://localhost:3000/sizes', _this.sizes)
                    .subscribe();
            }
        };
    }
